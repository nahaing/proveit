          ...
          <div class="row">
            ...
            >
              <div class="mt-5 mb-5">
                ...
                <div class="row">
                  <h2 class="intro-title">What is ProveIt ?</h2>
                </div>
                <div class="row">
                ...
                <div class="carousel-inner intro-carousel">
                  <div class="carousel-item active">
                    <div class="intro-text">
                      ...
                      <br />
                      <br />
                      Between 800,000 to 900,000 insurance policies were sold to
                      Jewish victims of the Holocaust yet only 47,353 insurance
                      policies were paid out. The value of unpaid Holocaust-era
                      insurance policies ranges from $17 billion to $200
                      billion. When it comes to shares of corporations, in
                      France alone, the shares of over 45,000 Jewish companies
                      were expropriated and handed over to non-Jewish persons.
                      Other types of shares involving public corporations held
                      in safety deposit boxes were confiscated and transferred
                      to German agencies by collaborating banks in the EU. Very
                      few of these sorts of claims have obtained legal closure.
                      <br />
                      <br />
                      There is an urgency to resolve these claims. The victims
                      of the holocaust, now in the later stages of life, control
                      the last vestiges of the documentary evidence vital to the
                      restitution of looted assets. Such evidence is extremely
                      fragile.
                    </div>
                  </div>
                </div>
